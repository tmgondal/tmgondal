...
### Education	
2019-2021	MS in Electrical Engineering
COMSATS University Islamabad, Lahore Campus Pakistan
CGPA: 3.43/4.0 
Thesis Title: Anomaly Detection and Load Forecasting in Short Term Electric Loads using Machine Learning Algorithms. (Read Here)
...
CGPA: 3.62/4.0
Project Title: Close loop speed control of three-phase BLDC Motor with Hall sensors
